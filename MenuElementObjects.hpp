...
MenuElement mi_12(&mi_11, &mi_11, "Знач. года", 2021, 2021, 2031, 1, &yearTune, setYear);
	
MenuElement mi_13(&mi_1, &mi_12, "Час");
MenuElement mi_14(&mi_13, &mi_13, "Знач. часа", 0, 0, 24, 1, &hourTune, setHour);

MenuElement mi_15(&mi_1, &mi_14, "Минута");
MenuElement mi_16(&mi_15, &mi_15, "Знач. минуты", 1, 1, 60, 1, &minuteTune, setMinute);
	
MenuElement mi_17(&mi_1, &mi_16, "День недели");
MenuElement mi_18(&mi_17, &mi_17, "Знач. дня недели", 1, 1, 7, 1, &weekDayTune, setWeekDay);
...
MenuElement mi_23(&mi_22, &mi_22, "Подключ. мощн.", 1, 0, 9000, 100, &upSocketLoadPower, setUpSocketLoadPower);

MenuElement mi_24(&mi_21, &mi_23, "Разъем 12 вольт");
MenuElement mi_25(&mi_24, &mi_24, "Подключ. мощн.", 1, 0, 1000, 1, &v12LoadPower, setV12SocketLoadPower);

MenuElement mi_26(&mi_21, &mi_25, "Нижняя розетка");
MenuElement mi_27(&mi_26, &mi_26, "Подключ. мощн.", 1, 0, 9000, 100, &downSocketLoadPower, setDownSocketLoadPower);
...
MenuElement mi_33(&mi_32, &mi_32, "Знач. температуры", 0, 0, 35, 1, &airFixTemp);
...
MenuElement mi_43(&mi_42, &mi_42, "Знач. фикс. темп.", 1, 0, 100, 1, &batFixTemp);
...
MenuElement mi_48(&mi_47, &mi_47, "Ноль. уров. CO", 300, 300, 1500, 10, &CONullLevel);
...
MenuElement mi_53(&mi_52, &mi_52, "Порог выключения", 1, 0, 4065, 5, &LightEdge);

MenuElement mi_54(&mi_31, &mi_53, "Всегда включено", 1, &LightProfileIndex);
MenuElement mi_55(&mi_54, &mi_54, "Порог выключения", 1, 0, 4065, 5, &LightEdge);

MenuElement mi_56(&mi_31, &mi_55, "Задержка выключения");
MenuElement mi_57(&mi_56, &mi_56, "Знач. задерж. сек.", 1, 0, 3600, 60, &LightSwitchOffDelay);
...
MenuElement mi_66(&mi_65, &mi_65, "П1 температ.", 1, 0, 100, 5, &mashingPause1Temp);
MenuElement mi_67(&mi_64, &mi_66, "П1 время");
MenuElement mi_68(&mi_67, &mi_67, "П1 время", 1, 0, 720, 5, &mashingPause1Time);

//mashing Pause 2
MenuElement mi_69(&mi_63, &mi_68, "Пауза 2");
MenuElement mi_70(&mi_69, &mi_69, "П2 темп.");
MenuElement mi_71(&mi_70, &mi_70, "П2 температ.", 1, 0, 100, 5, &mashingPause2Temp);
MenuElement mi_72(&mi_69, &mi_71, "П2 время");
MenuElement mi_73(&mi_72, &mi_72, "П2 время", 1, 0, 720, 5, &mashingPause2Time);

//mashing Pause 3
MenuElement mi_74(&mi_63, &mi_73, "Пауза 3");
MenuElement mi_75(&mi_74, &mi_74, "П3 темп.");
MenuElement mi_76(&mi_75, &mi_75, "П3 температ.", 1, 0, 100, 5, &mashingPause3Temp);
MenuElement mi_77(&mi_74, &mi_76, "П3 время");
MenuElement mi_78(&mi_77, &mi_77, "П3 время", 1, 0, 720, 5, &mashingPause3Time);

//mashing Pause 4
MenuElement mi_79(&mi_63, &mi_78, "Пауза 4");
MenuElement mi_80(&mi_79, &mi_79, "П4 темп.");
MenuElement mi_81(&mi_80, &mi_80, "П4 температ.", 1, 0, 100, 5, &mashingPause4Temp);
MenuElement mi_82(&mi_79, &mi_81, "П4 время");
MenuElement mi_83(&mi_82, &mi_82, "П4 время", 1, 0, 720, 5, &mashingPause4Time);

//mashing Pause 5
MenuElement mi_84(&mi_63, &mi_83, "Пауза 5");
MenuElement mi_85(&mi_84, &mi_84, "П5 темп.");
MenuElement mi_86(&mi_85, &mi_85, "П5 температ.", 1, 0, 100, 5, &mashingPause5Temp);
MenuElement mi_87(&mi_84, &mi_86, "П5 время");
MenuElement mi_88(&mi_87, &mi_87, "П5 время", 1, 0, 720, 5, &mashingPause5Time);

//mashing Pause 6
MenuElement mi_89(&mi_63, &mi_88, "Пауза 6");
MenuElement mi_90(&mi_89, &mi_89, "П6 темп.");
MenuElement mi_91(&mi_90, &mi_90, "П6 температ.", 1, 0, 100, 5, &mashingPause6Temp);
MenuElement mi_92(&mi_89, &mi_91, "П6 время");
MenuElement mi_93(&mi_92, &mi_92, "П5 время", 1, 0, 720, 5, &mashingPause6Time);
...
MenuElement mi_97(&mi_96, &mi_96, "П1 температ.", 1, 0, 100, 5, &boilingPause1Temp);
MenuElement mi_98(&mi_95, &mi_97, "П1 время");
MenuElement mi_99(&mi_98, &mi_98, "П1 время", 1, 0, 720, 5, &boilingPause1Time);

//boiling Pause 2
MenuElement mi_100(&mi_94, &mi_99, "Пауза 2");
MenuElement mi_101(&mi_100, &mi_100, "П2 темп.");
MenuElement mi_102(&mi_101, &mi_101, "П2 температ.", 1, 0, 100, 5, &boilingPause2Temp);
MenuElement mi_103(&mi_100, &mi_102, "П2 время");
MenuElement mi_104(&mi_103, &mi_103, "П2 время", 1, 0, 720, 5, &boilingPause2Time);

//boiling Pause 3
MenuElement mi_105(&mi_94, &mi_104, "Пауза 3");
MenuElement mi_106(&mi_105, &mi_105, "П3 темп.");
MenuElement mi_107(&mi_106, &mi_106, "П3 температ.", 1, 0, 100, 5, &boilingPause3Temp);
MenuElement mi_108(&mi_105, &mi_107, "П3 время");
MenuElement mi_109(&mi_108, &mi_108, "П3 время", 1, 0, 720, 5, &boilingPause3Time);
...
MenuElement mi_113(&mi_112, &mi_112, "Знач. года", 2021, 2021, 2031, 1, &delayBeginYear);
	
MenuElement mi_114(&mi_111, &mi_113, "Месяц");
MenuElement mi_115(&mi_114, &mi_114, "Знач. месяца", 1, 1, 12, 1, &delayBeginMonth);
	
MenuElement mi_116(&mi_111, &mi_115, "День");
MenuElement mi_117(&mi_116, &mi_116, "Знач. дня", 1, 1, 31, 1, &delayBeginDate);
	
MenuElement mi_118(&mi_111, &mi_117, "Час");
MenuElement mi_119(&mi_118, &mi_118, "Знач. часа", 0, 0, 24, 1, &delayBeginHour);
	
MenuElement mi_120(&mi_111, &mi_119, "Минута");
MenuElement mi_121(&mi_120, &mi_120, "Знач. минуты", 1, 0, 60, 1, &delayBeginMinute);
...
MenuElement mi_128(&mi_127, &mi_127, "Знач. года", 2021, 2021, 2031, 1, &delayEndYear);
	
MenuElement mi_129(&mi_126, &mi_128,"Месяц");
MenuElement mi_130(&mi_129, &mi_129,"Знач. месяца", 1, 1, 12, 1, &delayEndMonth);
	
MenuElement mi_131(&mi_126, &mi_130, "День");
MenuElement mi_132(&mi_131, &mi_131, "Знач. дня", 1, 1, 31, 1, &delayEndDate);
	
MenuElement mi_133(&mi_126, &mi_132, "Час");
MenuElement mi_134(&mi_133, &mi_133, "Знач. часа", 1, 0, 24, 1, &delayEndHour);
	
MenuElement mi_135(&mi_126, &mi_134, "Минута");
MenuElement mi_136(&mi_135, &mi_135, "Знач. минуты", 1, 0, 60, 1, &delayEndMinute);
...
MenuElement mi_142(&mi_141, &mi_141, "Температура = ", 50, 20, 80, 5, &dryingFixTemp);
	
MenuElement mi_143(&mi_140, &mi_142, "День ночь", 1, &dryingAirTempProfileIndex);
MenuElement mi_144(&mi_143, &mi_143, "Темпер. день");
MenuElement mi_145(&mi_144, &mi_144, "Температура = ", 20, 20, 80, 5, &dryingFixTempDay);	
	
MenuElement mi_146(&mi_143, &mi_145, "Темпер. ночь");
MenuElement mi_147(&mi_146, &mi_146, "Температура = ", 20, 20, 80, 5, &dryingFixTempNight);
...
MenuElement mi_153(&mi_152, &mi_152, "Влажность < ", 1, 1, 4065, 100, &DryingDryLevel);
...
MenuElement mi_162(&mi_161, &mi_161, "Сек. включено", 600, 1, 4065, 10, &dryingVentOnPeriod);
MenuElement mi_163(&mi_160, &mi_162, "Период выкл");
MenuElement mi_164(&mi_163, &mi_163, "Сек. выключено", 600, 1, 4065, 10, &dryingVentOffPeriod);
...
MenuElement mi_173(&mi_172, &mi_172, "Время сек.", 2, 0, IR_MOTION_BUFFER_SIZE, 1, &OnIfMotionPeriod);
...
MenuElement mi_179(&mi_178, &mi_178, "Время сек.", 2, 0, IR_MOTION_BUFFER_SIZE, 1, &longPeriodOnIfMotionPeriod);