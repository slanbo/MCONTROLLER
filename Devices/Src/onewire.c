...
inline uint8_t OneWire_Reset(OneWire_t* OneWireStruct)
{
	...
	GPIO_PinState pstate = HAL_GPIO_ReadPin(OneWireStruct->GPIOx, OneWireStruct->GPIO_Pin);
	//ONEWIRE_HIGH(OneWireStruct);
	//ONEWIRE_DELAY(500);
	...
	ONEWIRE_DELAY(70);
	/* Check bit value */
	pstate = HAL_GPIO_ReadPin(OneWireStruct->GPIOx, OneWireStruct->GPIO_Pin);
	
	/* Delay for 410 us */
	ONEWIRE_DELAY(410);
	/* Return value of presence pulse, 0 = OK, 1 = ERROR */
	if (pstate == GPIO_PIN_SET)
	{
		return 1;
	}
