...
SensorsSocketsControl airTempContr("Темпер. возд.:", &airTempControlOnOffTune, &airTempControlSensors, &airTempControlUpSockets, &airTempControlDownSockets, airTermistorsV);
